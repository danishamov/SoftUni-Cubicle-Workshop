...
const { getDifficultyOptionsVueData } = require("../utils/viewHelpers");
...
router.get("/create", isAuth, (req, res) => {
  // console.log(cubeManager.allCubs());
...
router.get("/:cubeId/delete", isAuth, async (req, res) => {
  const cube = await cubeManager.getOne(req.params.cubeId).lean();
  const options = getDifficultyOptionsVueData(cube.difficultyLevel);
